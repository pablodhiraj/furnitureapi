...
$search=$_POST['search'];
$sqlproducts = "SELECT * FROM products where name LIKE '%$search%' or category LIKE '%$search%'";
...
<div class="container">
	<div class="row">
		<div class="col-lg-12"><center><h3>Search Results</h3></center></div>
	</div>
</div>
<br><br>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="alert alert-danger" role="alert">
          <center>No Result Found Please Try Some Other Terms</center>
        </div>
      </div>
    </div>
  </div>
